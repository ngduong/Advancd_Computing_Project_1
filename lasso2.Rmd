...
df_0.3 %>% 
  ...
  geom_point(aes(y=(strong_prfm)*100, color="prop_wai")) + 
 geom_point(aes(y=(wai_prfm)*100, color="prop_wai")) + 
 geom_point(aes(y=(wbc_prfm)*100, color="prop_wbc")) + 
  geom_point(aes(y=(null_prfm)*100, color="prop_wai")) + 
   geom_line(aes(y=(strong_prfm)*100, color="prop_wai")) + 
  geom_line(aes(y=(wai_prfm)*100, color="prop_wai")) + 
  geom_line(aes(y=(wbc_prfm)*100, color="prop_wbc")) + 
   geom_line(aes(y=(null_prfm)*100, color="prop_wai")) + 
 labs(title = "Percent of weak signals included in the LASSO  model(corr = 0.3)",
...
mse_df2 %>% 
  ...
  geom_violin(aes(x = n_param_total, y = MSE, color = n_param_total))+
   labs(title = "MSE of strong signals(corr = 0.3)",
       x = "Number of (pre-set) total parameters",
       y = "MSE") +  
   theme_bw()+
